...
const title="반려생활 가이드",description="동물병원, 동물약국, 장례시설과 진료비 정보를 안전하게 확인하는 방법을 안내합니다.",canonical="/guide";
export const metadata: Metadata = { title, description, alternates:{canonical}, ...shareMetadata(title,description,canonical) };
