...
type AdsenseEnv = {
  ...
  NEXT_PUBLIC_ADSENSE_SLOT_PHARMACY_LIST_1?: string;
...
function currentAdsenseEnv(): AdsenseEnv {
  return {
    ...
    NEXT_PUBLIC_ADSENSE_SLOT_PHARMACY_LIST_1: process.env.NEXT_PUBLIC_ADSENSE_SLOT_PHARMACY_LIST_1,
...
export function adsenseSlot(placement: AdPlacement, env: AdsenseEnv = currentAdsenseEnv()) {
  ...
  if (placement === "PHARMACY_LIST_1") return env.NEXT_PUBLIC_ADSENSE_SLOT_PHARMACY_LIST_1 || undefined;
