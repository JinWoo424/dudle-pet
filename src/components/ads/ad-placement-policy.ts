...
export const PHARMACY_LIST_AD_AFTER_CARD = 6;
export const PHARMACY_LIST_AD_MINIMUM_FACILITIES = 8;
...
export function shouldInsertPharmacyListAd(totalFacilities: number, visibleFacilities: number) {
  return (
    totalFacilities >= PHARMACY_LIST_AD_MINIMUM_FACILITIES &&
    visibleFacilities >= PHARMACY_LIST_AD_AFTER_CARD
  );
}
