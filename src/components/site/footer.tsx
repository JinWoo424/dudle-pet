    ...
    <footer className="site-footer">
      <div className="shell footer-inner">
        ...
        <div className="footer-nav-groups">
          <nav className="footer-links" aria-label="서비스 메뉴"><strong>서비스</strong><Link href="/hospital" prefetch={false}>동물병원</Link><Link href="/pharmacy" prefetch={false}>동물약국</Link><Link href="/cost" prefetch={false}>진료비</Link></nav>
